			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h4 v-show="data_list"><i class="nav-icon fas fa-tags"></i>&nbsp;&nbsp;Products and Promos : {{ brand_name }}
							<a type="button" href="/portal/tenants" class="btn btn-secondary btn-sm"><i class="fa fa-angle-double-left"></i>&nbsp;Back to Tenants</a>
						</h4>
						<h4 v-show="add_record && data_form"><i class="nav-icon fas fa-user-plus"></i> Add New Product</h4>
						<h4 v-show="edit_record && data_form"><i class="nav-icon fas fa-user-edit"></i> Edit Product</h4>
					</div>
					<div class="card-body">
						<Table 
	...
	export default {
        ...
        data() {
            return {
            	...
            	primaryKey: "id",
            	dataUrl: "/portal/tenant/product/list/"+this.tenant_id,
            	actionButtons: {
            		delete: {
            			title: 'Delete this Product',
            			name: 'Delete',
            			apiUrl: '/portal/tenant/product/delete/'+this.tenant_id,
            			routeName: '',
        ...
        methods: {
            ...
            storeProduct: function() {
				axios.post('/portal/tenant/store-brand-products', this.frm_product)
				.then(response => {
