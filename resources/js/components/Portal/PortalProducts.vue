					...
					<div class="modal-body">
						<div class="card-body">
							...
							<div class="form-group row mb-4">
								...
								<div class="col-sm-5">
                                    <div class="mb-4"><input type="file" accept="image/*" ref="thumbnail" @change="thumbnailChange"></div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
                                    <div class="mb-4"><input type="file" accept="image/*" ref="image_url" @change="image_urlChange"></div>
									<footer class="blockquote-footer">image max size is 120 x 120 pixels</footer>
								</div>
								<div class="col-sm-3 text-center">
							...
							<div class="form-group row" v-show="edit_record">
								...
								<div class="col-sm-8">
									<div class="form-check form-switch form-switch-md mb-3">
										<input type="checkbox" class="custom-control-input form-check-input" id="isActive" v-model="product.active">
