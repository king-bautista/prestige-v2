<template>
	<div>
		...
		<div class="modal fade" id="site-ad-promos-form" data-backdrop="static" tabindex="-1" aria-labelledby="site_ad-form" aria-hidden="true">
	...
	export default {
        ...
        methods: {
			...
			AddNewAdvertisements: function() {
				...
				this.material = null;
              	$('#site-ad-promos-form').modal('show');
            },
            ...
            storeAdvertisements: function() {
				...
				.then(response => {
					...
					this.$refs.dataTable.fetchData();
	              	$('#site-ad-promos-form').modal('hide');
				});				
            },
