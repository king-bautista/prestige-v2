						...
						<div class="card">
							<div class="card-body">
								<Table :dataFields="dataFields" :dataUrl="dataUrl" :actionButtons="actionButtons"
									...
									v-on:editButton="editBrand" v-on:modalBatchUpload="modalBatchUpload" ref="dataTable">
								</Table>
							</div>
						</div>
					</div>
			...
			<div class="col-md-12">
				<div class="card m-3">
						...
						<div class="form-group row mb-4">
							...
							<div class="col-sm-8">
								<multiselect v-model="brand.supplementals" :options="supplementals" :multiple="true"
									:close-on-select="true" placeholder="Select Supplementals" label="name" track-by="name"
									@select="toggleSelected" @remove="toggleUnSelected">
								</multiselect>
							</div>
						</div>
						<div class="form-group row mb-4">
							...
							<div class="col-sm-8">
								<multiselect v-model="brand.tags" :options="tags" :multiple="true" :close-on-select="true"
									placeholder="Select Tags" label="name" track-by="name" @select="toggleSelectedTags"
					...
					<div class="card-footer text-right">
						...
						<button type="button" class="btn btn-primary pull-right" v-show="add_record" @click="storeBrand">Add
							New Brand</button>
						...
						<form>
							<div class="form-group col-md-12">
								...
								<div class="custom-file">
									<div class="mb-4"><input type="file" ref="file" v-on:change="handleFileUpload()"
											accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
											class="custom-file-input" id="batchInput"></div>
