<template>
	<div>
		...
		<div class="modal fade" id="site-ad-banner-form" data-backdrop="static" tabindex="-1" aria-labelledby="site-ad-banner-form" aria-hidden="true">
	...
	export default {
        ...
        methods: {
			...
			AddNewAdvertisements: function() {
				...
				this.material = null;
              	$('#site-ad-banner-form').modal('show');
            },
            ...
            storeAdvertisements: function() {
				...
				.then(response => {
					...
					this.$refs.dataTable.fetchData();
	              	$('#site-ad-banner-form').modal('hide');
				});				
            },
