			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h4 v-show="data_list"><i class="nav-icon fa fa-building"></i>&nbsp;&nbsp;View Tickets</h4>
					</div>
					<div class="card-body" v-show="data_list">
						<Table :dataFields="dataFields" :dataUrl="dataUrl" :primaryKey="primaryKey" ref="dataTable">
						</Table>
					</div>
				</div>
			</div>
	...
	data() {
		return {
			...
			dataFields: {
				...
				ticket_description: "Ticket Decription",
				status_id: {
					name: "Status",
					type: "Boolean",
					status: {
