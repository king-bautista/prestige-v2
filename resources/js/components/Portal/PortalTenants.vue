	...
	export default {
        ...
        data() {
            return {
            	...
            	primaryKey: "id",
            	dataUrl: "/portal/site/tenant/list",
            	actionButtons: {
            		edit: {
            		...
            		delete: {
            			...
            			name: 'Delete',
            			apiUrl: '/portal/site/tenant/delete',
            			routeName: '',
					...
					link: {
            			...
            			name: 'Link',
            			apiUrl: '/portal/site/tenant/products',
            			routeName: '',
        ...
        methods: {
            ...
            storeTenant: function() {
                ...
                axios.post('/portal/site/tenant/store', formData, {
					headers: {
			...
			editTenant: function(id) {
                axios.get('/portal/site/tenant/'+id)
                .then(response => {
					this.tenant.operational_hours = [];
					schedules = [];
            ...
            updateTenant: function() {
				...
				formData.append("instagram", this.tenant.instagram);
				formData.append("website", this.tenant.website);
                axios.post('/portal/site/tenant/update', formData, {
					headers: {
						'Content-Type': 'multipart/form-data'
					},
				})
			...
			removeTenant: function() {
				axios.get('/portal/site/tenant/delete/'+this.id_to_deleted)
                .then(response => {
                    this.$refs.tenantsDataTable.fetchData();
			...
			storeBatch: function() {
	            ...
	            axios.post( '/portal/site/tenant/batch-upload' , formData,
	            {
	                headers: {
	                    'Content-Type': 'multipart/form-data'
	                }
