	...
	export default {
        ...
        methods: {
			GetParentLinks: function() {
				axios.get('/portal/modules/get-all-links')
            ...
            storeModule: function() {
                axios.post('/portal/modules/store', this.module)
				.then(response => {
            ...
            updateModule: function() {
                axios.put('/portal/modules/update', this.module)
                    .then(response => {
                        toastr.success(response.data.message);
                        this.$refs.dataTable.fetchData();
						this.GetParentLinks();
