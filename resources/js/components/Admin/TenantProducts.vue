	...
	export default {
        ...
        data() {
            return {
            	...
            	primaryKey: "id",
            	dataUrl: "/admin/site/tenant/product/list/"+this.tenant_id,
            	actionButtons: {
            		delete: {
            			title: 'Delete this Product',
            			name: 'Delete',
            			apiUrl: '/admin/site/tenant/product/delete/'+this.tenant_id,
            			routeName: '',
        ...
        methods: {
			getProductByBrand() {
				axios.get('/admin/brand/product-by-id/'+this.brand_id)
            ...
            storeProduct: function() {
				axios.post('/admin/site/tenant/store-brand-products', this.frm_product)
				.then(response => {
