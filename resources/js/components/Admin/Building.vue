						...
						<div class="card">
							...
							<div class="card-body">
								<Table :dataFields="dataFields" :dataUrl="dataUrl" :actionButtons="actionButtons"
									...
									v-on:AddNewBuilding="AddNewBuilding" v-on:editButton="editBuilding" v-on:modalBatchUpload="modalBatchUpload"
...
export default {
	...
	methods: {
		...
		storeBatch: function () {
			...
			axios.post('/admin/site/buildings/batch-upload', formData,
				{
					headers: {
