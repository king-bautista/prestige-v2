				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h5 class="modal-title" v-show="edit_record"><i class="fa fa-pencil-square-o"
								aria-hidden="true"></i> Edit Supplemental</h5>
					...
					<div class="modal-body">
						<div class="card-body">
							<div class="form-group row">
								<label for="firstName" class="col-sm-4 col-form-label">Supplemental Name <span
										class="font-italic text-danger"> *</span></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" v-model="supplemental.name"
							...
							<div class="form-group row">
								<label for="lastName" class="col-sm-4 col-form-label">Descriptions <span
										class="font-italic text-danger"> *</span></label>
								<div class="col-sm-8">
									<textarea class="form-control" v-model="supplemental.descriptions"
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<treeselect v-model="supplemental.parent_id" :options="parent_supplementals"
										placeholder="Select Parent Supplemental" />
								</div>
							</div>
							<div class="form-group row">
								<label for="lastName" class="col-sm-4 col-form-label">Category</label>
								<div class="col-sm-8">
									<treeselect v-model="supplemental.category_id" :options="categories"
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" v-show="add_record" @click="storeSupplemental">Add New
							Supplemental</button>
						<button type="button" class="btn btn-primary" v-show="edit_record" @click="updateSupplemental">Save
							Changes</button>
					</div>
				</div>
			</div>
