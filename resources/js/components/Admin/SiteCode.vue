	          ...
	          <div class="col-md-12">
	          	<div class="card">
	    			<div class="card-body">
						...
						v-on:AddNewSiteCode="AddNewSiteCode"
						v-on:editButton="editSiteCode"
                        ref="dataTable">
			          	</Table>
		          	</div>
		        </div>
			...
			<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="add_record"><i class="fa fa-plus" aria-hidden="true"></i> Add New Site Code</h5>
						<h5 class="modal-title" v-show="edit_record"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Site Code</h5>
					...
					<div class="modal-body">
						<div class="card-body">
                            ...
                            <div class="form-group row">
								<label for="firstName" class="col-sm-4 col-form-label">Cinema ID <span class="font-italic text-danger"> *</span></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" v-model="site_code.cinema_id" placeholder="SiteCode Label" required>
								</div>
							</div>
						</div>
					<!-- /.card-body -->
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" v-show="add_record" @click="storeSiteCode">Add New Site Code</button>
						<button type="button" class="btn btn-primary" v-show="edit_record" @click="updateSiteCode">Save Changes</button>
					</div>
				</div>
			</div>
		</div>
