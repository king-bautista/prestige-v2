				...
				<div class="col-md-12">
					<div class="card m-3">
						<div class="card-header">
							...
							<button type="button" class="btn btn-primary btn-sm m-0 float-right" @click="AddNewContract"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Add</button>
						</div>
						<div class="card-body">
							<div class="table-responsive mt-2">
								<table class="table table-hover" id="dataTable" style="width:100%">
									...
									<tbody>
										<tr v-for="(data, index) in company.contracts" v-bind:key="index">
											...
											<td>
												<img v-for="(brand, index) in data.brands"  class="img-thumbnail" :src="brand.logo_image_path" />
											</td>
											...
											<td class="align-middle text-nowrap">
												<button type="button" class="btn btn-outline-danger" @click="deleteModal('removeContract',index)" title="Delete"><i class="fas fa-trash-alt"></i></button>
												<button type="button" class="btn btn-outline-danger" @click="editContract(data.id)" title="Edit"><i class="fas fa-edit"></i></button>
											</td>
										</tr>
									</tbody>
								</table>
			...
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary btn-sm float-right" v-show="add_record" @click="storeCompany">Add New Company</button>
						<button type="button" class="btn btn-primary btn-sm float-right" v-show="edit_record" @click="updateCompany">Save Changes</button>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<multiselect v-model="contract.brands"
									:options="company.brands"
									:multiple="true"
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<multiselect v-model="contract.screens"
									:options="screens"
									:multiple="true"
									:close-on-select="true"
						...
						<div class="form-group row">
							<label for="firstName" class="col-sm-4 col-form-label">Duration (no. of days) <span class="font-italic text-danger"> *</span></label>
							<div class="col-sm-8">
								<input type="text" class="form-control" :disabled="contract.is_indefinite" v-model="contract.display_duration" placeholder="0" required>
							</div>
						</div>
						<div class="form-group row">
							<label for="firstName" class="col-sm-4 col-form-label">No. of slots per loop <span class="font-italic text-danger"> *</span></label>
							<div class="col-sm-8">
								<input type="text" class="form-control" v-model="contract.slots_per_loop" placeholder="0" required>
							</div>
						</div>
						<div class="form-group row">
							<label for="firstName" class="col-sm-4 col-form-label">Exposure per day <span class="font-italic text-danger"> *</span></label>
							<div class="col-sm-8">
								<input type="text" class="form-control" v-model="contract.exposure_per_day" placeholder="0" required>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input" id="is_indefinite" v-model="contract.is_indefinite">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input" id="is_exclusive" v-model="contract.is_exclusive">
						...
						<div class="form-group row" v-show="edit_record">
							...
							<div class="col-sm-8">
								<div class="custom-control custom-switch">
									<input type="checkbox" class="custom-control-input" id="isActive" v-model="contract.active">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary float-right" data-bs-dismiss="modal">Close</button>
						<button type="button" class="btn btn-primary btn-sm float-right" v-show="add_record" @click="storeContract">Add New Contract</button>
						<button type="button" class="btn btn-primary btn-sm float-right" v-show="edit_record" @click="updateContract">Save Changes</button>
					</div>
				</div>
			</div>
		</div>
