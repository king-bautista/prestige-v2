							...
							<div class="card-body">
								...
								<div class="form-group row">
									<label for="firstName" class="col-sm-4 col-form-label">TIN Number <span
											class="font-italic text-danger"> *</span></label>
									<div class="col-sm-8">
										<input type="text" class="form-control" v-model="company.tin"
								...
								<div class="table-responsive mt-2">
									<table class="table table-hover" style="width:100%">
										<tr v-for="(data, index) in company.brands" v-bind:key="index">
											...
											<td class="align-middle"><button type="button" class="btn btn-outline-danger"
													@click="removeBrand(index)"><i class="fas fa-trash-alt"></i>
													Remove</button></td>
										</tr>
									</table>
								</div>
