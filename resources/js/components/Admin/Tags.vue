	          ...
	          <div class="col-md-12">
	          	<div class="card">
	    			<div class="card-body">
						...
						v-on:AddNewTag="AddNewTag"
						v-on:editButton="editTag"
			...
			<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" v-show="add_record"><i class="fa fa-plus" aria-hidden="true"></i> Add New Tag</h5>
						<h5 class="modal-title" v-show="edit_record"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Tag</h5>
					...
					<div class="modal-body">
						<div class="card-body">
							<div class="form-group row">
								<label for="firstName" class="col-sm-4 col-form-label">Tag Name <span class="font-italic text-danger"> *</span></label>
								<div class="col-sm-8">
							...
							<div class="form-group row" v-show="edit_record">
								...
								<div class="col-sm-8">
									<div class="custom-control custom-switch">
										<input type="checkbox" class="custom-control-input" id="isActive" v-model="tag.active">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" v-show="add_record" @click="storeTag">Add New Tag</button>
						<button type="button" class="btn btn-primary" v-show="edit_record" @click="updateTag">Save Changes</button>
					</div>
				</div>
			</div>
		</div>
