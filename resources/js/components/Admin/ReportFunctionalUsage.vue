	...
	export default {
        ...
        data() {
            return {
            	...
            	primaryKey: "id",
            	dataUrl: "/admin/reports/functional-usage/list",
				otherButtons: {
					addNew: {
						title: 'Filter',
						v_on: 'reportModal',
        ...
        methods: {
			...
			filterChart: function() {
				...
				$(function() {
					$.get( "/admin/reports/functional-usage/list", filter, function( data ) {
						let datasets = [];
            ...
            downloadCsv: function() {
              ...
              axios.get('/admin/reports/functional-usage/download-csv', {params: {filters: this.filter}})
              .then(response => {
