				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h5 class="modal-title" v-show="edit_record"><i class="fa fa-pencil-square-o"
								aria-hidden="true"></i> Edit Screen</h5>
					...
					<div class="modal-body">
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" v-model="screen.name" placeholder="Screen Name"
										required>
								</div>
							</div>
							<div class="form-group row">
								<label for="firstName" class="col-sm-4 col-form-label">Screen Type <span
										class="font-italic text-danger"> *</span></label>
								<div class="col-sm-8">
									<select class="custom-select" v-model="screen.screen_type">
										<option value="">Select Screen Type</option>
										<option v-for="screen_type in screen_types" :value="screen_type"> {{ screen_type }}
										</option>
									</select>
								</div>
							</div>
							<div class="form-group row">
								<label for="firstName" class="col-sm-4 col-form-label">Orientation <span
										class="font-italic text-danger"> *</span></label>
								<div class="col-sm-8">
									<select class="custom-select" v-model="screen.orientation">
										<option value="">Select Orientation</option>
										<option v-for="orientation in orientations" :value="orientation"> {{ orientation }}
										</option>
									</select>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<select class="custom-select" v-model="screen.product_application">
										...
										<option v-for="application in product_applications" :value="application"> {{
											application }}</option>
									</select>
								</div>
							</div>
							<div class="form-group row">
								<label for="firstName" class="col-sm-4 col-form-label">Site <span
										class="font-italic text-danger"> *</span></label>
								<div class="col-sm-8">
									<select class="custom-select" v-model="screen.site_id"
							...
							<div class="form-group row">
								<label for="firstName" class="col-sm-4 col-form-label">Building <span
										class="font-italic text-danger"> *</span></label>
								<div class="col-sm-8">
									<select class="custom-select" v-model="screen.site_building_id"
...
export default {
	...
	methods: {
		...
		downloadTemplate: function () {
			axios.get('/admin/site/screen/download-csv-template')
				.then(response => {
					const link = document.createElement('a');
					link.href = response.data.data.filepath;
					link.setAttribute('download', response.data.data.filename); //or any other extension
