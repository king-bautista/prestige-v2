				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h5 class="modal-title" v-show="edit_record"><i class="fa fa-pencil-square-o"
								aria-hidden="true"></i> Edit Tenant</h5>
						...
						<div class="card-body">
							...
							<div class="form-group row">
								<label for="firstName" class="col-sm-3 col-form-label">Building <span
										class="font-italic text-danger"> *</span></label>
								<div class="col-sm-9">
									<select class="custom-select" v-model="tenant.site_building_id"
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" v-show="add_record" @click="storeTenant">Add New
							Tenant</button>
						<button type="button" class="btn btn-primary" v-show="edit_record" @click="updateTenant">Save
							Changes</button>
					</div>
				</div>
			</div>
...
export default {
	...
	methods: {
		...
		downloadCsv: function () { 
			axios.get('/admin/site/tenant/download-csv')
				 .then(response => {
