...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    */
    ...
    Route::get('/admin/brand/download-csv/{ids}', 'Admin\BrandController@downloadCsv')->name('admin.brand.download-csv');
    ...
    Route::get('/admin/brand/count', 'Admin\BrandController@countBrands')->name('admin.brand.count');
    ...
    */
    ...
    Route::get('/admin/site/manage-config/origin-point', 'Admin\MapsController@getOriginPoint')->name('admin.site.map.origin-point');
    ...
    Route::post('/admin/site/map/delete-line', 'Admin\MapsController@deleteLine')->name('admin.site.map.delete-line');
    ...
    */
    ...
    Route::post('/admin/play-list/batch-upload-test', 'Admin\ContentManagementController@batchUploadTest')->name('admin.play-list.batch-upload-test');
    ...
    Route::get('/admin/play-list/download-playlists-sequence', 'Admin\ContentManagementController@downloadCsvPlaylistTemplate')->name('admin.play-list.download-playlists-sequence');
    /*
    |--------------------------------------------------------------------------
    | Genre Routes
    |--------------------------------------------------------------------------
