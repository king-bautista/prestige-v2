...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    */
    ...
    Route::get('/admin/play-list/download-playlists-sequence', 'Admin\ContentManagementController@downloadPlayListSequence')->name('admin.play-list.download-playlists-sequence');
    /*
    |--------------------------------------------------------------------------
    | Genre Routes
    |--------------------------------------------------------------------------
