    ...
    <div class="container">
        <div class="row">
            ...
            <div style="float: left; border-radius: 18px; box-shadow: 0 3px 6px rgb(0 0 0 / 0.16);">
                <div style="float: left; width: 423px; height: 62px !important;">
                    <select class="form-control select direction-to d-inline-block translateselect2 select2-hidden-accessible" style="width: 423px; height: 63.5px !important; font-family: 'Henry Sans Regular' !important; height: 65px; border-top-left-radius: 18px; border-bottom-left-radius: 18px;" tabindex="-1" data-select2-id="537">
                ...
                <div style="float: left;">
                    <button class="btn-prestige-rounded3 btn-pwd btn-prestige-white" style="width: 67px; height: 64px; outline-style: none; border-top-right-radius: 18px !important; border-bottom-right-radius: 18px; border: 0.5px solid gray !important;">
                        <svg class="svg-inline--fa fa-wheelchair fa-w-16" style="font-size: 26px;" focusable="false" data-prefix="fa" data-icon="wheelchair" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" >
            ...
            <div style="float: left; margin-left: 20px; border-radius: 18px; box-shadow: 0 3px 6px rgb(0 0 0 / 0.16);">
                <div style="float: left; width: 161px;">
                    <select class="form-control select floor-select my-auto select2-hidden-accessible" style="height: 64px; border-top-left-radius: 18px; border-bottom-left-radius: 18px;" id="floor-select" data-select2-id="floor-select" tabindex="-1">
                ...
                <div style="float: left;">
                    <a class="maprepeat btn btn-prestige-rounded3 my-auto" style="background-color: #ffffff; border-top-right-radius: 18px !important; border-bottom-right-radius: 18px !important; border-top: 1px solid #aaa; border-right: 1px solid #aaa; border-bottom: 1px solid #aaa; border-left: 0px; color: #0030ff; width: 67px; height: 64px; display: none;" >
                        <svg class="svg-inline--fa fa-history fa-w-16" style="font-size: 26px;" focusable="false" data-prefix="fa" data-icon="history" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" >
