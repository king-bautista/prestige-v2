...
<div class="row">
    <div class="promo-featured-container" id="bigcontainer">
        <div class="col-sm-12">
            <div class="">
                <img type="button" id="imgPromoBannerBtn" class="promo-banner-card" src="resources\uploads\promos\Featured Promo.png" />
            </div>
        </div>
        <div class="col-sm-12" class="store-page-client-content">
            <div class="row promo-row-container" id="PromoRowContainer" >
                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-4 promo-col-container">
                    <div class="card border-0 bg-transparent promo-card">
                        <img type="button" id="imgPromoBtnTenant" class="promo-img" src="resources/uploads/promos/popup700px700px.png" />
                    </div>
                </div>
